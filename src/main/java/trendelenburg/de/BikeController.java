...
class BikeController {
     ...
     */
    BikeController(String P1_UP, String P1_DOWN, String P1_LEFT, String P1_RIGHT, String P2_UP, String P2_DOWN, String P2_LEFT, String P2_RIGHT, Stage stage) {

        stage.getScene().setOnKeyTyped(keyEvent -> {
            Biker P1_bike = MainApp.biker.get(0);
            if(P1_bike!=null){
            ...
            Biker P2_bike = MainApp.biker.get(1);
            if(P2_bike!=null){
                if(keyEvent.getCharacter().equals(P2_UP)){
